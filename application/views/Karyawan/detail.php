                ...
                <div class="col-md-12">
					...
					<table class="table table-striped">
						<tbody>
							...
							<tr>
								<th>Download KTP</th>
								<td> <a href="<?php echo base_url().'Karyawan/Download/'.$data['id'].'/'.$data['file_ktp']?>"> <?php echo $data['file_ktp']?>(Download)  </td>
							</tr>
							<tr>
								<th>Download KK</th>
								<td> <a href="<?php echo base_url().'Karyawan/Download/'.$data['id'].'/'.$data['file_kk']?>"> <?php echo $data['file_kk']?>(Download)  </td>
							</tr>
						</tbody>
					</table>
