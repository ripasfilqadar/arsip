  ...
  <form id="myform" method="POST" role="form" action=<?= site_url($url);?> enctype="multipart/form-data" autocomplete="off">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Form <?$state?> Surat Keluar</h4>
        <div class="row">
          <div class="col-md-12">
          <div class="box-body">
            <div class="row">
			  ...
			  <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" required class="form-control" name="tujuan" placeholder="Tujuan Surat" value="<?php if($isEdit) echo $data['tujuan']?>" >
                </div>  
								<div class="form-group">
