...
<div class="modal fade" id="modal-st">
  <div class="modal-dialog modal-lg">
    <?php $this->view('SuratMasuk/form');?>
  </div>
</div>
<?php $this->view('SuratMasuk/delete');?>
<!-- /.modal -->
                    ...
                    <?php
                      ...
                      <tr data-vendor='<?php echo json_encode($surat)?>'>
                        ...
                        <td> <?php
												...
												<td> <?php
													$phpdate = strtotime( $surat['tanggal_rekam'] );
													echo date( 'd-M-Y', $phpdate ) 
													?> 
												</td>
												<td> <a href="<?php echo base_url().'SuratMasuk/Download/'.$surat['id'].'/'.$surat['file_surat']?>"> Download </td>
                        <td>
                        <a href="<?php echo site_url('SuratMasuk/edit/'.$surat['id']);?>">
                          <button type="button" class="btn btn-info " aria-label="Left Align">
                            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                          </button>
                        </a>
												<a href="<?php echo site_url('SuratMasuk/detail/'.$surat['id']);?>">
                          <button type="button" class="btn btn-info " aria-label="Left Align">
