<div class="modal fade" id="deleteVendor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
...
$(document).ready(() => {
  $("#datatable").on("click",".js-btn-delete",function(){
    ...
    $('.js-modal-delete-body').html("Apakah anda yakin menghapus vendor " + dataVendor.NamaVendor + "?");
    $("#deleteVendor form input[name='Id'").val(dataVendor.VendorId);
